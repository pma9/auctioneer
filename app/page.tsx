...
export default function Home() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,#fef3c7,transparent_34%),linear-gradient(135deg,#f8fafc,#e2e8f0)] px-6 py-12 text-slate-950">
      <main className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-6xl flex-col justify-center">
        ...
        <h1 className="mt-5 max-w-4xl text-5xl font-black tracking-tight sm:text-7xl">
          Private hybrid Vickrey auctions for real-world events.
        </h1>
